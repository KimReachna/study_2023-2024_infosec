...
2.	Аналогично создала второго пользователя guest2 и выполнили вход в эту учетную запись

![Создание и установка пароля для пользователя guest2](image/1.png){ #fig:001 width=70% height=70% }

3.	Добавила пользователя guest2 в группу guest используя команду: ```gpasswd –a guest2 guest```

![Добавление пользователей guest2 в группу guest](image/2.png){ #fig:001 width=70% height=70% }
...
![Информация о пользователях](image/3.png){ #fig:002 width=70% height=70% }
...
![Содержимое файла /etc/group и регистрация в группе](image/4.png){ #fig:003 width=70% height=70% }
...
![Изменение прав у директории](image/5.png){ #fig:004 width=70% height=70% }
...
![Заполнение таблицы](image/6.png){ #fig:005 width=70% height=70% }
