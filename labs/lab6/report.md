...
![getenforce и sestatus](image/1.png)
...
6. Определите тип файлов и поддиректорий, находящихся в директории /var/www, с помощью команды ```ls -lZ /var/ww```w. В поддиректориях могут располагаться системные скрипты и контент для http.
...
![создание html-файла и доступ по http](image/6.png){ #fig:004 width=70% height=70%}
...
![ошибка доступа после изменения контекста](image/7.png){ #fig:005 width=70% height=70%}
...
![лог ошибок](image/8.png){ #fig:006 width=70% height=70%}
...
![переключение порта](image/9.png){ #fig:007 width=70% height=70%}
...
![доступ по http на 81 порт](image/10.png){ #fig:008 width=70% height=70%}
