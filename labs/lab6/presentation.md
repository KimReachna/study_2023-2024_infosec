...
date: 12 октября, 2023, Москва, Россия
...
![создание html-файла и доступ по http](image/6.png){ #fig:002 width=70% height=70%}

## Изменение контекста безопасности

![ошибка доступа после изменения контекста](image/7.png){ #fig:003 width=70% height=70%}

## Переключение порта и восстановление контекста безопасности

![доступ по http на 81 порт](image/10.png){ #fig:004 width=70% height=70%}
